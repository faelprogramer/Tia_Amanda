...
import java.awt.event.KeyAdapter; 
    ...
    */ 
    public class JNumberFormatField extends JTextField { 
        ...
        public JNumberFormatField(int casasDecimais, int limite) { 
            this(new DecimalFormat((casasDecimais == 0 ? "#,##0" : "#,##0.") + makeZeros(casasDecimais)));
            this.limit = limite;
        }
        ...
        public static void main(String[] args) { 
            javax.swing.JFrame frame = new javax.swing.JFrame("Teste do campo"); 
            frame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE); 
            frame.setResizable(false); 
            frame.add(new JNumberFormatField(2, 4)); 
            frame.pack(); 
